...
const Search = () => {
    ...
    setSearch('react')
    return (
            <div className="relative rounded-4 bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 w-screen sm:mr-auto">
               <div className="mr-auto max-w-md">
                  <form action='' className='relative w-max mr-auto'>
